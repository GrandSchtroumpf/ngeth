...
function numberToBN(arg) {
    if (typeof arg === 'string' || typeof arg === 'number') {
        let /** @type {?} */ multiplier = new BN(1);
        const /** @type {?} */ formattedString = String(arg)
            .toLowerCase()
            .trim();
        const /** @type {?} */ isPrefixed = formattedString.substr(0, 2) === '0x' ||
            formattedString.substr(0, 3) === '-0x';
        let /** @type {?} */ stringArg = stripHexPrefix(formattedString);
...
const /** @type {?} */ keccak256 = keccak(256);
